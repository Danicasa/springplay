...
public class ProjectController {
	...
	public ResponseEntity<?> getById(@PathVariable int projectId){
		Projects project = service.getById(projectId);
		return ResponseEntity.ok(project);
	}
	...
	@PostMapping("/save")
	public ResponseEntity<?> save(@RequestBody Projects project){
		Projects projectDB = service.save(project);
		return ResponseEntity.status(HttpStatus.CREATED).body(projectDB);
	}
	
	@PostMapping("/delete")
	public ResponseEntity<?> delete(@RequestBody Projects project){
		Projects projectDB = service.save(project);
		return ResponseEntity.status(HttpStatus.CREATED).body(projectDB);
	}
